...
urlpatterns = [
    ...
    path('results/<poll_id>/', poll_views.results, name='results'),
     ...
     path('signup',poll_views.handlesignup , name="handlesignup"), 
    path('login',poll_views.handlelogin, name="handlelogin"), 
    path('logout',poll_views.handlelogout , name="handlelogout"), 
]